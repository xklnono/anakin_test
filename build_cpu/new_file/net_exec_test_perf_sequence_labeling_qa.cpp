...
DEFINE_GLOBAL(std::string, model_dir, "/home/qa_work/CI/workspace/sys_anakin_compare_output/sequence_labeling/models/");
DEFINE_GLOBAL(std::string, input_file, "/home/qa_work/CI/workspace/sys_anakin_compare_output/sequence_labeling/input_file/perf-eval.legoraw");
DEFINE_GLOBAL(std::string, output_file, "/home/qa_work/CI/workspace/sys_anakin_compare_output/sequence_labeling/images_output/");
DEFINE_GLOBAL(std::string, time_result, "/home/qa_work/CI/workspace/sys_anakin_compare_output/sequence_labeling/time/");
...
int main(int argc, const char** argv){
    ...
    if (argc < 1) {
        ...
        ./output/unit_test/net_exec_test_sequence_labeling\n \
            thread_num \n";
        exit(0);
    } else if (argc >= 2) {
