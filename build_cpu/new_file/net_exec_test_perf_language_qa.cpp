...
DEFINE_GLOBAL(std::string, model_dir, "/home/qa_work/CI/workspace/sys_anakin_compare_output/language/models/");
DEFINE_GLOBAL(std::string, input_file, "/home/qa_work/CI/workspace/sys_anakin_compare_output/language/input_file/fake_realtitle.test");
DEFINE_GLOBAL(std::string, output_file, "/home/qa_work/CI/workspace/sys_anakin_compare_output/language/images_output/");
DEFINE_GLOBAL(std::string, time_result, "/home/qa_work/CI/workspace/sys_anakin_compare_output/language/time/");
...
int main(int argc, const char** argv) {
    ...
    if (argc < 1) {
        ...
        ./output/unit_test/net_exec_test_language \n \
             thread_num\n";
        exit(0);
    } else if (argc >=2 ) {
