...
macro(anakin_find_opencv)
    if(BUILD_SHARED) # temporary not support static link opencv.
		...
		set(CMAKE_FIND_ROOT_PATH ~/.jumbo/)
...
macro(anakin_find_protobuf)
    #set(PS_RPOTO_ROOT "~/usrbin3")
    #include_directories(${PS_RPOTO_ROOT}/include)
    #set(PROTOBUF_LIBRARIES "")
    #list(APPEND PROTOBUF_LIBRARIES ${PS_RPOTO_ROOT}/lib/libprotobuf.so)
    #list(APPEND PROTOBUF_LIBRARIES ${PS_RPOTO_ROOT}/lib/libprotobuf-lite.a)
    #list(APPEND PROTOBUF_LIBRARIES ${PS_RPOTO_ROOT}/lib/libprotoc.a)
