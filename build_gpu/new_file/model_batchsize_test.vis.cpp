...
//DEFINE_GLOBAL(std::string, test_list, "/home/qa_work/CI/workspace/sys_anakin_compare_output/model_name/src_name/batch" + GLB_num + "/file.list");
//DEFINE_GLOBAL(std::string, file_root, "/home/qa_work/CI/workspace/sys_anakin_compare_output/model_name/src_name/batch" + GLB_num + "/");
...
TEST(NetTest, net_execute_base_test) {
    ...
    std::ifstream fin;
    std::string test_list = "/home/qa_work/CI/workspace/sys_anakin_compare_output/model_name/src_name/batch" + GLB_num + "/file.list";
    ...
    while(fin >> file_name) {
       ...
       // }
        ...
        std::string file_root = "/home/qa_work/CI/workspace/sys_anakin_compare_output/model_name/src_name/batch" + GLB_num + "/";
