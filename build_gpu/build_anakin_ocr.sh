...
CUR_PATH=`pwd`
if [ $1 == "anakin_p4" ]; then
    COMPILE_ROOT_PATH="/home/qa_work/CI/workspace/sys_anakin_build/sys_anakin_merge_build"
elif [ $1 == "anakin_k1200" ]; then
    COMPILE_ROOT_PATH="/home/qa_work/CI/workspace/sys_anakin_build/sys_anakin_merge_build_k1200"
fi
...
if [ $1 == "anakin_p4" ]; then
    cp $CUR_PATH/ocr_diff_width_p4.cpp $ANAKIN2_ROOT_PATH/test/framework/net/
else
    cp $CUR_PATH/ocr_diff_width_k1200.cpp $ANAKIN2_ROOT_PATH/test/framework/net/
fi

echo "cp src file done!"
