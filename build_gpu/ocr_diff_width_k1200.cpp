...
DEFINE_GLOBAL(std::string, height, "1500");
//DEFINE_GLOBAL(std::string, test_list, "/home/qa_work/CI/workspace/sys_anakin_compare_output/ocr20/input_file/batch" + GLB_num + "/file.list");
//DEFINE_GLOBAL(std::string, file_root, "/home/qa_work/CI/workspace/sys_anakin_compare_output/ocr20/input_file/batch" + GLB_num + "/");
...
std::string model_saved_path = "/home/qa_work/CI/workspace/sys_anakin_compare_output/ocr20/models/";
...
TEST(NetTest, net_execute_base_test) {
    ...
    std::ifstream fin;
    std::string test_list = "/home/qa_work/CI/workspace/sys_anakin_compare_output/ocr20/input_file/batch" + GLB_num + "/file.list" + "_" + GLB_height;
    ...
    while(fin >> file_name) {
       ...
       // }
        ...
        std::string file_root = "/home/qa_work/CI/workspace/sys_anakin_compare_output/ocr20/input_file/batch" + GLB_num + "/";
        ...
        //std::istringstream str( "fc_2.tmp_out;" ); 
...
int main(int argc, const char** argv){
    ...
    exit(0);
        ...
        GLB_height = argv[2];
        LOG(INFO) << "Current height_size is : " << GLB_height;
    }
