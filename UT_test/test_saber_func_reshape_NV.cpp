...
TEST(TestSaberFuncReshapeNV, test_func_reshape) {
    ...
    dev_reshape_4d.compute_output_shape(output_dev_4d, input_dev_4d, param_dev_4d);
    dev_reshape_2d.compute_output_shape(output_dev_2d, input_dev_4d, param_dev_2d);
    ...
    tdevice_out_4d.re_alloc(shape_out_4d);
    thost_out_2d.re_alloc(shape_out_2d);
    tdevice_out_2d.re_alloc(shape_out_2d);
    ...
    host_reshape_2d.init(input_host_4d, output_host_2d, param_host_2d, \
        SPECIFY, VENDER_IMPL, ctx_host);
    dev_reshape_4d.init(input_dev_4d, output_dev_4d, param_dev_4d, \
        SPECIFY, VENDER_IMPL, ctx_dev);
    dev_reshape_2d.init(input_dev_4d, output_dev_2d, param_dev_2d, \
        SPECIFY, VENDER_IMPL, ctx_dev);
    ...
    LOG(INFO) << "reshape initialization";
    host_reshape_4d.init(input_host_4d, output_host_4d, param_host_4d, \
        STATIC, VENDER_IMPL, ctx_host);
    host_reshape_2d.init(input_host_4d, output_host_2d, param_host_2d, \
        STATIC, VENDER_IMPL, ctx_host);
    dev_reshape_4d.init(input_dev_4d, output_dev_4d, param_dev_4d, \
        STATIC, VENDER_IMPL, ctx_dev);
    dev_reshape_2d.init(input_dev_4d, output_dev_2d, param_dev_2d, \
        STATIC, VENDER_IMPL, ctx_dev);
    ...
    TensorDf4 tdevice_out_4d_reset;
    std::vector<TensorDf4*> output_dev_4d_reset;
    output_dev_4d_reset.push_back(&tdevice_out_4d_reset);
    std::vector<TensorDf4*> input_dev_4d_reset;
    input_dev_4d_reset.push_back(&tdevice_in);
    Reshape<NV, AK_FLOAT> dev_reshape_4d_reset;

    dev_reshape_4d_reset.reset_output_shape(input_dev_4d_reset, \
        output_dev_4d_reset, param_dev_4d, ctx_dev);
    dev_reshape_4d_reset.init(input_dev_4d_reset, output_dev_4d_reset, param_dev_4d, \
        SPECIFY, VENDER_IMPL, ctx_dev);
    
    dev_reshape_4d_reset(input_dev_4d_reset, output_dev_4d_reset, param_dev_4d, ctx_dev);
    print_tensor_device(*output_dev_4d_reset[0]);
    cudaDeviceSynchronize();
}
