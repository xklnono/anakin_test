...
if __name__ == "__main__":
    ...
    ModelPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/fluid_models/'
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == "2":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch2/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch2/'
        elif sys.argv[1] == "4":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch4/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch4/'
        elif sys.argv[1] == "8":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch8/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch8/'
        elif sys.argv[1] == "32":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch32/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch32/'
        else:
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch1/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch1/' 
    else:
        TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch1/file.list'
        cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/input_file/batch1/'
    output_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/mainbody/paddle_output/'
    print TxtPath
    fp = open(TxtPath)
    line = fp.readline()
    while line:
