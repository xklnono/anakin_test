...
if __name__ == "__main__":
    ...
    target_output_varname = 'fc_reduce.tmp_1'
    target_input_varname = 'data_output'
    num = 1
    channel = 3
    height = 222
    width = 222
    ...
    ModelPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/fluid_models/'
    ...
    if len(sys.argv) == 2:
        if sys.argv[1] == "2":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch2/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch2/'
        elif sys.argv[1] == "4":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch4/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch4/'
        elif sys.argv[1] == "8":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch8/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch8/'
        elif sys.argv[1] == "32":
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch32/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch32/'
        else:
            TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch1/file.list'
            cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch1/' 
    else:
        TxtPath = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch1/file.list'
        cur_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/input_file/batch1/'
    output_path = '/home/qa_work/CI/workspace/sys_anakin_compare_output/plant_v2/paddle_output/'
    print TxtPath
    fp = open(TxtPath)
    line = fp.readline()
    while line:
