...
class LoadPerformance(object):
    ...
    def analysis_dev_sec(self):
        ...
        if self.db_onoff == "on":
            ...
            #self.mysql.insert_table_sql_nvidia_version(self.gpu_pertime[len(self.gpu_pertime)-1], version_gpu_usage_percent_all, version_gpu_mem_all, version_gpu_temper_max)
            # use time_id
