...
class LoadPerformance(object):
    ...
    def make_excel_result(self):
        ...
        # 11. accuracy rate
        accuracy_rate_p4 = self.mysql.select_accuracy_rate("p4")
        accuracy_rate_k1200 = self.mysql.select_accuracy_rate("k1200")
        if accuracy_rate_p4 == 0.0:
            ratio_accuracy_rate_p4 = "0%"
        elif accuracy_rate_p4 and accuracy_rate_p4 != 0.0:
            ratio_accuracy_rate_p4 = str(int(accuracy_rate_p4) * 100) + "%"
        else:
            ratio_accuracy_rate_p4 = None

        if accuracy_rate_k1200 == 0.0:
            ratio_accuracy_rate_k1200 = "0%"
        elif accuracy_rate_k1200 and accuracy_rate_k1200 != 0.0:
            ratio_accuracy_rate_k1200 = str(int(accuracy_rate_k1200) * 100) + "%"
        else:
            ratio_accuracy_rate_k1200 = None

        print "ratio_accuracy_rate_p4: %s" % ratio_accuracy_rate_p4
        print "ratio_accuracy_rate_k1200: %s" % ratio_accuracy_rate_k1200
        ...
        line_data_p4["ratio_accuracy_rate_p4"] = ratio_accuracy_rate_p4
        ...
        line_data_k1200["ratio_accuracy_rate_k1200"] = ratio_accuracy_rate_k1200
...
class LoadExcel(object):
    ...
    def __init__(self):
        ...
        col.width = 256 * 20
        col1 = self.worksheet_k1200.col(10)
        col1.width = 256 * 20
        ...
        self.worksheet_k1200.write(0, 10, "accuracy rate\n(%)", self.style_background10)
    ...
    def put_in_excel_p4(self, line_data):
        ...
        if line_data["ratio_accuracy_rate_p4"]:
            data = int(line_data["ratio_accuracy_rate_p4"].rstrip("%"))
            if data == 100:
                self.worksheet_p4.write(GLOBAL_LINE, 10, line_data["ratio_accuracy_rate_p4"], self.style)
            else:
                self.worksheet_p4.write(GLOBAL_LINE, 10, line_data["ratio_accuracy_rate_p4"], self.style_red)
        else:
            self.worksheet_p4.write(GLOBAL_LINE, 10, line_data["ratio_accuracy_rate_p4"], self.style)
    ...
    def put_in_excel_k1200(self, line_data):
        ...
        if line_data["ratio_accuracy_rate_k1200"]:
            data = int(line_data["ratio_accuracy_rate_k1200"].rstrip("%"))
            if data == 100:
                self.worksheet_k1200.write(GLOBAL_LINE, 10, line_data["ratio_accuracy_rate_k1200"], self.style)
            else:
                self.worksheet_k1200.write(GLOBAL_LINE, 10, line_data["ratio_accuracy_rate_k1200"], self.style_red)
        else:
            self.worksheet_k1200.write(GLOBAL_LINE, 10, line_data["ratio_accuracy_rate_k1200"], self.style)
