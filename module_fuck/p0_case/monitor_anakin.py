...
def get_monitor_prog_pid(model, gpu_card):
    ...
    try:
        cmd = cf.get(conf_name, "p0_anakin2_ps_cmd") % gpu_card
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 4:
        ...
        try:
            ...
            jorcold_start_cmd = cf.get(conf_name, "p0_anakin2_jorcold_start_cmd") % (gpu_card, batch_size)
        except Exception as e:
    ...
    if len(sys.argv) == 3:
        ...
        ut_yolo_path = "/home/qa_work/CI/workspace/sys_anakin_merge_build/output"
        jorcold_start_cmd = cf.get("conf_yolo", "p0_anakin2_jorcold_start_cmd") % (gpu_card, batch_size)
