...
################################################################################
"""
Compare Paddle with anakin2.0 output Func() Method!
...
def paddle_read_inputfile_into_data(filename, name_list=""):
    #TODO
    if name_list == "":
...
def one_pic_beyond(src_file, dst_file, name_list):
    src_data = paddle_read_inputfile_into_data(src_file, name_list)
    dst_data = paddle_read_inputfile_into_data(dst_file, name_list)
...
if __name__ == '__main__':
    ...
    for root, dirs, files in os.walk(src_path):
        ...
        for file in files:
            ...
            #print "-----------file_name_list: %s" % file_name_list[-1]
