...
def get_monitor_prog_pid(model, cpu_card):
    ...
    try:
        cmd = cf.get(conf_name, "paddle_ps_cmd") % cpu_card
...
def jorcold_start_test_yolo(top_result_file, ut_yolo_path, jorcold_start_cmd, model, cpu_card):
    ...
    print "55555555444444333332222++++++++++++"
    os.system(jorcold_start)
    print "666666444444333332222++++++++++++"
...
if __name__ == '__main__':
    ...
    if len(sys.argv) == 4:
        ...
        try:
            ...
            print "444444333332222++++++++++++"
            jorcold_start_cmd = cf.get(conf_name, "paddle_jorcold_start_cmd") % (taskset_c, cpu_card, thread_size)
